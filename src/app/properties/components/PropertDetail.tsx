      ...
      <div className="min-h-screen bg-background pt-24 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/properties">
            <Button className="tyrent-gradient text-white font-montserrat">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Button size="sm" variant="outline" className="font-nunito">
            ...
            <Card className="sticky top-24 shadow-xl">
              <CardContent className="p-6">
                ...
                <div className="space-y-4 mb-6">
                  <div>
                    <label className="text-sm font-medium mb-2 block font-montserrat">
                      Move-in Date
                    </label>
                    <input
                      type="date"
                ...
                <Button className="w-full tyrent-gradient text-white mb-4 py-6 text-lg font-montserrat">
                  Request Viewing
                </Button>
        ...
        {similarProperties.length > 0 && (
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {similarProperties.map((similar) => similar && (
                <Link key={similar.id} href={`/properties/${similar.slug}`}>
                  <Card className="overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 tyrent-card-hover cursor-pointer">
                    ...
                    <CardContent className="p-4">
                      <h3 className="font-bold text-lg mb-2 font-montserrat line-clamp-1">
                        {similar.title}
                      </h3>
